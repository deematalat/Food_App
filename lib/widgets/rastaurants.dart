...
import 'package:food_final/widgets/smallButton.dart';
...
class Rastaurantwidget extends StatelessWidget {
  final RestaurantModel rastaurant;

  const Rastaurantwidget({  Key? key, required this.rastaurant}) : super(key: key);
                      ...
                      child: Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(rastaurant.rating.round().toString()),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: RichText(
                        text: TextSpan(children: [
                          ...
                          TextSpan(
                            text: rastaurant.avgPrice.round().toString(),
                            style: TextStyle(
